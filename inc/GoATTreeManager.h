...
private:
    ...
    GTreeParticle*		rootino;    // reconstructed
    GTreeParticle*		photon;		// reconstructed
    GTreeParticle*		elektron;	// reconstructed
    GTreeParticle*		piplus;		// reconstructed
    GTreeParticle*		proton;		// reconstructed
    GTreeParticle*		neutron;	// reconstructed
    GTreeParticle*		pi0;		// reconstructed
    GTreeParticle*		eta;		// reconstructed
    GTreeParticle*		etap;		// reconstructed
